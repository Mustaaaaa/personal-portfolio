    ...
    return (
        ...
        <div id="home" className="flex relative w-full justify-center flex-col">
            ...
            <div className="fixed top-0 left- min-h-[calc(100vh)] w-full px-[calc(25%)] -z-10  flex flex-col items-center justify-center pt-20 ">
                <div className="flex flex-col md:flex-row justify-center items-center text-center md:text-let">
                    <div>
                        <p data-aos="fade-down-right" className="text-6xl md:text-8xl break-al">Moustafa</p>
                        <p data-aos="fade-up-left" className="text-6xl md:text-8xl pl-0 md:pl-64 ">Ibrahim</p>
                        <p className="text-3xl ml-0 md:ml-20 break-al text-black container-text-dynamic">
                ...
                <div className="flex justify-center items-center max-w-[calc(800px)] z-50">
                    <Lottie
                ...
                {showButton && (
                    <div data-aos="zoom-in-up"
                        ...
                        <a href="https://html.spec.whatwg.org/"
                            ...
                            <svg data-aos="fade-right" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 384 512" class="text-4xl text-red-600" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a href="https://www.w3.org/TR/CSS/"
                            class="p-3 border-800 hover:scale-150 duration-300 group">
                            <span class="absolute bottom-full left-1/2 -translate-x-1/2 text-white bg-black rounded-md p-2 text-xs opacity-0 group-hover:opacity-100 duration-300">CSS</span>
                            <svg data-aos="fade-down" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 384 512" class="text-4xl text-blue-800" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a href="https://sass-lang.com/"
                            class="p-3 border-800 hover:scale-150 duration-300 group">
                            <span class="absolute bottom-full left-1/2 -translate-x-1/2 text-white bg-black rounded-md p-2 text-xs opacity-0 group-hover:opacity-100 duration-300">SASS</span>
                            <svg data-aos="fade-up" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 640 512" class="text-4xl text-pink-400" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a href="https://tailwindcss.com/" class="p-3 border-800 hover:scale-150 duration-300 group">
                            <span class="absolute bottom-full left-1/2 -translate-x-1/2 text-white bg-black rounded-md p-2 text-xs opacity-0 group-hover:opacity-100 duration-300">TAILWINDCSS</span>
                            <svg data-aos="fade-down" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" class="text-4xl text-cyan-500" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a href="https://getbootstrap.com/" class="p-3 border-800 hover:scale-150 duration-300 group">
                            <span class="absolute bottom-full left-1/2 -translate-x-1/2 text-white bg-black rounded-md p-2 text-xs opacity-0 group-hover:opacity-100 duration-300">BOOTSTRAP</span>
                            <svg data-aos="fade-up" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 576 512" class="text-4xl text-purple-800" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a href="https://react.dev/" class="p-3 border-800 hover:scale-150 duration-300 group">
                            <span class="absolute bottom-full left-1/2 -translate-x-1/2 text-white bg-black rounded-md p-2 text-xs opacity-0 group-hover:opacity-100 duration-300">REACT</span>
                            <svg data-aos="fade-down" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 512 512" class="text-4xl text-cyan-400" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a href="https://vuejs.org/" class="p-3 border-800 hover:scale-150 duration-300 group">
                            <span class="absolute bottom-full left-1/2 -translate-x-1/2 text-white bg-black rounded-md p-2 text-xs opacity-0 group-hover:opacity-100 duration-300">VUE.JS</span>
                            <svg data-aos="fade-up" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 448 512" class="text-4xl text-green-700" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript" class="p-3 border-800 hover:scale-150 duration-300 group">
                            ...
                            <svg data-aos="fade-up" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 512 512" class="text-4xl text-yellow-300" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a href="https://laravel.com/" class="p-3 border-800 hover:scale-150 duration-300 group">
                            <span class="absolute bottom-full left-1/2 -translate-x-1/2 text-white bg-black rounded-md p-2 text-xs opacity-0 group-hover:opacity-100 duration-300">LARAVEL</span>
                            <svg data-aos="fade-down" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 512 512" class="text-4xl text-red-600" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a href="https://www.php.net/" class="p-3 border-800 hover:scale-150 duration-300 group">
                            <span class="absolute bottom-full left-1/2 -translate-x-1/2 text-white bg-black rounded-md p-2 text-xs opacity-0 group-hover:opacity-100 duration-300">PHP</span>
                            <svg data-aos="fade-up" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 640 512" class="text-4xl text-sky-800" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a href="https://www.mysql.com/" class="p-3 border-800 hover:scale-150 duration-300 group">
                            <span class="absolute bottom-full left-1/2 -translate-x-1/2 text-white bg-black rounded-md p-2 text-xs opacity-0 group-hover:opacity-100 duration-300">MYSQL</span>
                            <svg data-aos="fade-left" stroke="currentColor" fill="currentColor" stroke-width="0" role="img" viewBox="0 0 24 24" class="text-4xl text-sky-600" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
