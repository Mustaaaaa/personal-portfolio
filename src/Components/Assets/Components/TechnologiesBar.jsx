            ...
            {showButton && (
                <div data-aos="zoom-in-up"
                    ...
                    <a href="https://html.spec.whatwg.org/"
                        ...
                        <span className="absolute bottom-full left-1/2 -translate-x-1/2 text-white bg-black rounded-md p-2 text-xs opacity-0 group-hover:opacity-100 duration-300">HTML</span>
                    ...
                    <a href="https://www.w3.org/TR/CSS/"
                        className="p-3 border-800 hover:scale-150 duration-300 group">
                        <span className="absolute bottom-full left-1/2 -translate-x-1/2 text-white bg-black rounded-md p-2 text-xs opacity-0 group-hover:opacity-100 duration-300">CSS</span>
                    ...
                    <a href="https://sass-lang.com/"
                        className="p-3 border-800 hover:scale-150 duration-300 group">
                        <span className="absolute bottom-full left-1/2 -translate-x-1/2 text-white bg-black rounded-md p-2 text-xs opacity-0 group-hover:opacity-100 duration-300">SASS</span>
                        <svg data-aos="fade-up" stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 640 512" className="text-4xl text-pink-400" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a href="https://tailwindcss.com/" className="p-3 border-800 hover:scale-150 duration-300 group">
                        <span className="absolute bottom-full left-1/2 -translate-x-1/2 text-white bg-black rounded-md p-2 text-xs opacity-0 group-hover:opacity-100 duration-300">TAILWINDCSS</span>
                        <svg data-aos="fade-down" stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 24 24" className="text-4xl text-cyan-500" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a href="https://react.dev/" className="p-3 border-800 hover:scale-150 duration-300 group">
                        <span className="absolute bottom-full left-1/2 -translate-x-1/2 text-white bg-black rounded-md p-2 text-xs opacity-0 group-hover:opacity-100 duration-300">REACT</span>
                        <svg data-aos="fade-down" stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 512 512" className="text-4xl text-cyan-400" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a href="https://vuejs.org/" className="p-3 border-800 hover:scale-150 duration-300 group">
                        <span className="absolute bottom-full left-1/2 -translate-x-1/2 text-white bg-black rounded-md p-2 text-xs opacity-0 group-hover:opacity-100 duration-300">VUE.JS</span>
                    ...
                    <a href="https://vitejs.dev/" className="p-3 border-800 hover:scale-150 duration-300 group">
                        <span className="absolute bottom-full left-1/2 -translate-x-1/2 text-white bg-black rounded-md p-2 text-xs opacity-0 group-hover:opacity-100 duration-300">VITEJS</span>
                    ...
                    <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript" className="p-3 border-800 hover:scale-150 duration-300 group">
                        <span className="absolute bottom-full left-1/2 -translate-x-1/2 text-white bg-black rounded-md p-2 text-xs opacity-0 group-hover:opacity-100 duration-300">JAVASCRIPT</span>
                    ...
                    <a href="https://laravel.com/" className="p-3 border-800 hover:scale-150 duration-300 group">
                        <span className="absolute bottom-full left-1/2 -translate-x-1/2 text-white bg-black rounded-md p-2 text-xs opacity-0 group-hover:opacity-100 duration-300">LARAVEL</span>
                    ...
                    <a href="https://www.php.net/" className="p-3 border-800 hover:scale-150 duration-300 group">
                        <span className="absolute bottom-full left-1/2 -translate-x-1/2 text-white bg-black rounded-md p-2 text-xs opacity-0 group-hover:opacity-100 duration-300">PHP</span>
                    ...
                    <a href="https://www.mysql.com/" className="p-3 border-800 hover:scale-150 duration-300 group">
                        <span className="absolute bottom-full left-1/2 -translate-x-1/2 text-white bg-black rounded-md p-2 text-xs opacity-0 group-hover:opacity-100 duration-300">MYSQL</span>
