...
function ProjectSection() {
    ...
    return (
        <div id="projects" className='bg-white -mt-1'>
            ...
            <div className='mwrap'>
                <section ref={el => sectionsRef.current[0] = el} className='panel fooder'>
                    <div className="cover absolute top-0 left-0 w-full h-full bg-cover bg-center p-28 z-20">
                        ...
                        transform -translate-x-1/2 transition-all duration-500 ease-in-out hover:bg-white hover:text-black'>Who is L?</button>
                    </div>
                    <span className="close absolute top-28 right-28 z-10">
                    ...
                    <div className="inner">
                        ...
                        <div className="text">
                            <div className="box">
                                <h3>L Lawliet</h3>
                                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Repudiandae magnam repellat commodi, quibusdam possimus illo a, accusamus itaque voluptatibus deleniti magni corrupti quos? Excepturi dolores provident expedita harum error consequuntur.</p>
                            </div>
                        </div>
                    </div>
                </section>

                <section ref={el => sectionsRef.current[1] = el} className='panel fooder'>
                    <div className="cover absolute top-0 left-0 w-full h-full bg-cover bg-center p-24 z-20">
                        <h2>L</h2>
                        <button className='border-2 text-white px-8 py-2 rounded-full font-bold absolute bottom-28 left-1/2
                        transform -translate-x-1/2 transition-all duration-500 ease-in-out hover:bg-white hover:text-black'>Who is L?</button>
                    </div>
                ...
                <section ref={el => sectionsRef.current[2] = el} className='panel fooder'>
                    <div className="cover absolute top-0 left-0 w-full h-full bg-cover bg-center p-24 z-20">
                        <h2>L</h2>
                        <button className='border-2 text-white px-8 py-2 rounded-full font-bold absolute bottom-28 left-1/2
                        transform -translate-x-1/2 transition-all duration-500 ease-in-out hover:bg-white hover:text-black'>Who is L?</button>
