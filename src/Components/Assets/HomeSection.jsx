...
const HomeSection = () => {
    ...
    return (
        <div className="flex w-full justify-center flex-col items-center">
            ...
            <div className="md:h-[calc(90vh)] h-[calc(80vh - 64px)] md:pt-0 pt-14 lg:max-w-[calc(1920px)] w-full z-10  flex lg:flex-row flex-col-reverse items-center justify-center">
